...
export default {
  ...
  simulator: {
    ...
    assumptions: [
      ...
      'Les distributions suivent l’annexe II à la lettre : préservation du capital réel d’abord, moyenne lissée sur trois ans avec un tunnel de 125 %, aucun levier, tout en euros constants de 2026.',
