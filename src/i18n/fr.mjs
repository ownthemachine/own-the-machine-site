...
export default {
  ...
  home: {
    ...
    basis: 'Base juridique : articles 114 et 352 TFUE ; aucune modification des traités. <a href="%REG%">La proposition dans le format de la Commission.</a>',
    ...
    col3Head: 'La méthode',
    col3: 'Rédigée en public, soumise à des examens contradictoires, chaque verdict et chaque correction consignés. Le <a href="%LEDGER%">registre</a> montre la loi qui débat avec elle-même, et qui s’incline là où elle devait s’incliner.',
  ...
  lawIndex: {
    ...
    intro: 'Règles harmonisées pour la participation des citoyens aux gains de productivité issus de l’automatisation (le règlement sur le capital citoyen). La version de travail complète : <a href="%RECITALS%">30 considérants</a>, 18 articles et deux annexes, chaque paragraphe ancré et citable. Le texte anglais fait foi. À jour au commit %COMMIT% ; chaque modification figure au <a href="%LEDGER%">registre</a>.',
    citationLabel: 'Visas',
  ...
  ledger: {
    title: 'Le registre', eyebrow: 'La loi expose son cheminement',
  ...
  registration: {
    ...
    intro: 'L’enregistrement se décide sur ce texte, non sur le projet de règlement. La Commission apprécie les objectifs ; le projet accompagne la demande à titre d’illustration et peut être réduit couche par couche sans toucher aux objectifs.',
  },
  faq: {
  ...
  brief: {
    title: 'La proposition en bref', eyebrow: 'Note de synthèse',
