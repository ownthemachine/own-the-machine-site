...
export default {
  ...
  home: {
    ...
    basis: 'Rechtsgrundlage: Artikel 114 und 352 AEUV; keine Vertragsänderung. <a href="%REG%">Der Vorschlag im Format der Kommission.</a>',
  ...
  registration: {
    ...
    intro: 'Über die Registrierung wird anhand dieses Textes entschieden, nicht anhand des Verordnungsentwurfs. Die Kommission prüft die Ziele; der Entwurf begleitet den Antrag zur Veranschaulichung und kann Schicht für Schicht gekürzt werden, ohne die Ziele zu berühren.',
  },
  faq: {
