...
export default {
  ...
  chrome: {
    law: 'El reglamento', objections: 'Objeciones', ledger: 'Registro',
    faq: 'Preguntas frecuentes',
    join: 'Participar',
    simulator: 'Simulador', evidence: 'Pruebas', about: 'Quiénes somos',
  ...
  home: {
    ...
    basis: 'Base jurídica: artículos 114 y 352 del TFUE; sin modificación de los Tratados. <a href="%REG%">La propuesta en el formato de la Comisión.</a>',
    ...
    col3Head: 'El método',
    col3: 'Redactada en público, sometida a exámenes contradictorios, con cada veredicto y cada corrección en acta. El <a href="%LEDGER%">registro</a> muestra a la ley discutiendo consigo misma, y perdiendo los argumentos que merecía perder.',
  ...
  ledger: {
    title: 'El registro', eyebrow: 'La ley enseña cómo se hizo',
  ...
  registration: {
    title: 'La propuesta, en el formato de la Comisión', eyebrow: 'Lo que se presentaría',
    ...
    intro: 'El registro se decide sobre este texto, no sobre el proyecto de Reglamento. La Comisión evalúa los objetivos; el proyecto acompaña la solicitud a título ilustrativo y puede recortarse capa por capa sin tocar los objetivos.',
  },
  faq: {
  ...
  brief: {
    title: 'La propuesta en resumen', eyebrow: 'Resumen ejecutivo',
