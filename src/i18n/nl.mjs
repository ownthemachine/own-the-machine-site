...
export default {
  ...
  simulator: {
    ...
    assumptions: [
      ...
      'Uitkeringen volgen bijlage II exact: eerst reëel kapitaalbehoud, een driejarig voortschrijdend gemiddelde met een bandbreedte van 125 %, geen hefboom, alles in constante euro’s van 2026.',
