...
export default {
  ...
  chrome: {
    law: 'De verordening', objections: 'Bezwaren', ledger: 'Register',
    faq: 'Veelgestelde vragen',
    join: 'Meedoen',
    simulator: 'Simulator', evidence: 'Bewijs', about: 'Over ons',
  ...
  home: {
    ...
    basis: 'Rechtsgrondslag: artikelen 114 en 352 VWEU; geen verdragswijziging. <a href="%REG%">Het voorstel in het format van de Commissie.</a>',
    ...
    col3Head: 'De methode',
    col3: 'Openbaar opgesteld, aan strenge tegenspraak onderworpen, elk oordeel en elke correctie op schrift. Het <a href="%LEDGER%">register</a> toont hoe de wet met zichzelf in discussie gaat, en argumenten verliest die ze verdiende te verliezen.',
  ...
  lawIndex: {
    ...
    intro: 'Geharmoniseerde regels voor deelname van burgers aan geautomatiseerde productiviteitswinsten (de Burgerkapitaalverordening). Het volledige werkontwerp: <a href="%RECITALS%">30 overwegingen</a>, 18 artikelen en twee bijlagen, elke alinea verankerd en citeerbaar. De Engelse tekst geldt als het ontwerp. Actueel op commit %COMMIT%; elke wijziging staat in het <a href="%LEDGER%">register</a>.',
    citationLabel: 'Aanhef',
  ...
  ledger: {
    title: 'Het register', eyebrow: 'De wet legt verantwoording af',
  ...
  registration: {
    title: 'Het voorstel, in het format van de Commissie', eyebrow: 'Wat zou worden ingediend',
    description: 'Titel, doelstellingen en verdragsbepalingen binnen de grenzen van Verordening (EU) 2019/788, met tekentelling.',
    intro: 'Over de registratie wordt beslist op basis van deze tekst, niet van de ontwerpverordening. De Commissie beoordeelt de doelstellingen; het ontwerp reist mee ter illustratie en kan laag voor laag worden ingekort zonder de doelstellingen te raken.',
  },
  faq: {
  ...
  brief: {
    title: 'Het voorstel in het kort', eyebrow: 'Beknopte samenvatting',
