...
export default {
  ...
  home: {
    ...
    ask: 'Wanneer productie geen arbeid op grote schaal meer nodig heeft, hoort elke burger van de Unie een aandeel te bezitten in wat de machines voortbrengen. Dit is de wet die dat regelt: een volledige ontwerpverordening van de EU, openbaar geschreven, met de bezwaren in hun sterkste vorm gepubliceerd vóór de artikelen.',
    ctaRead: 'Lees de wet', ctaObjections: 'Begin bij de bezwaren',
    col1Head: 'Het mechanisme',
    col1: 'Eén stemrechtloze warrant per hypergeautomatiseerd bedrijf: 3 % van het kapitaal, pas uitgeoefend op het moment dat de eigenaren zelf verzilveren. Niets is opeisbaar in contanten en niets vloeit naar de staatskas.',
    col2Head: 'De aanspraak',
    col2: 'Elke volwassen burger van de Unie heeft een gelijke, persoonlijke, onaantastbare aanspraak op een gemeenschappelijke Reserve. Geen inkomens- of vermogenstoets, geen aanvraag, geen voorwaarden. Uitkeringen beginnen klein en groeien over een generatie aan.',
    col3Head: 'De methode',
  ...
  lawIndex: {
    ...
    intro: 'Geharmoniseerde regels voor deelname van burgers aan geautomatiseerde productiviteitswinsten (de Burgerkapitaalverordening). Het volledige werkontwerp: <a href="%RECITALS%">30 overwegingen</a>, 18 artikelen en twee bijlagen, elke alinea verankerd en citeerbaar. De Engelse tekst is het ontwerp. Actueel op commit %COMMIT%; elke wijziging staat in het <a href="%LEDGER%">grootboek</a>.',
  ...
  simulator: {
    ...
    sceptic: 'Behoudend scenario', reset: 'Herstel',
    ...
    assumptions: [
      ...
      'De adoptie loopt lineair op over tien jaar vanaf de mediane doorlooptijd; gerechtigde volwassenen: 350 miljoen (Eurostat, Unieburgers 18+).',
  ...
  contribute: {
    title: 'Draag bij', eyebrow: 'De wet als open broncode',
