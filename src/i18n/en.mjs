...
export default {
  ...
  simulator: {
    ...
    assumptions: [
      ...
      'Adoption ramps linearly over ten years from the median event lag; eligible adults: 350 million (Eurostat, Union citizens 18+).',
      'Distributions follow Annex II exactly: real capital preserved first, a three-year smoothing average with a 125 % collar, no leverage, everything in constant 2026 euros.',
