...
export default {
  ...
  home: {
    ...
    basis: 'Legal basis: Articles 114 and 352 TFEU; no Treaty change. <a href="%REG%">The proposal in the Commission’s format.</a>',
  ...
  registration: {
    ...
    intro: 'Registration is decided on this text, not on the draft Regulation. The Commission assesses the objectives; the draft travels as an illustration and can be trimmed by layer without touching them.',
  },
  faq: {
