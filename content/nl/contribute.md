...
- [own-the-machine](https://github.com/ownthemachine/own-the-machine): de wet, de toelichting, het reviewregister (CC BY-
  SA 4.0).
- [own-the-machine-tools](https://github.com/ownthemachine/own-the-machine-tools): de toetsen en de linter (MIT).
...
beperkingen (de DC-tabel in de [bezwaren](/law/objections)) en zes toetsen met review op
...
- **Redigeer.** Verbeter een artikel aan de hand van de conventies van de
  Joint Practical Guide; de linter en de toetsen staan u op te wachten.
