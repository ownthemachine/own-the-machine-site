...
const sections = [
  ...
  { id: 'objections', title: 'Memorandum: the objections, at full strength', html: law.objections.en.html },
  { id: 'severability', title: 'Memorandum: severability', html: law.severability.en.html },
];
