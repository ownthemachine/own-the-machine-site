...
# The long horizon, es: fidelity gate on evidence section 7 and the new simulator strings
...
Round 1 (REVISE): parte dispositiva for the operative-article calque,
puede verse capturada, rendimientos comparables a los de Noruega, and
dividendo in the generation sentence. Round 2: PUBLISH.

Reviewer: google/gemini-3.7-flash via review.sh; raw outputs in
translations/docreview-es-horizon.md at review time.
